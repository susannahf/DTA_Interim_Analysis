...
The following graphs illustrate where the method terminates in a realistic DTA, using interim points defined by total number of participants.
...
The following graphs illustrate where the method terminates in a realistic DTA, using interim points defined by number of positive participants.
